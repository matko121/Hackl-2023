...
$entries['command.bus'] = function ($c) {
    $commands = [
        ...
        Booking\Appointment\RejectBookingRemotelyCommand::class   => new Booking\Appointment\RejectBookingRemotelyCommandHandler($c),
        Booking\Appointment\ApproveBookingRemotelyCommand::class  => new Booking\Appointment\ApproveBookingRemotelyCommandHandler($c),
