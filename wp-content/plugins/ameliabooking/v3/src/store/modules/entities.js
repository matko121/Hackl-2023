    ...
    if (ent === 'employees') {
      ...
      entities[ent].forEach((employee, employeeIndex) => {
        employee.serviceList.forEach((employeeService, serviceIndex) => {
          ...
          let employeeCustomPricing = entities[ent][employeeIndex].serviceList[serviceIndex].customPricing
          ...
          entities[ent][employeeIndex].serviceList[serviceIndex].customPricing = employeeCustomPricing

          entities[ent][employeeIndex].serviceList[serviceIndex].customPricing = getParsedCustomPricing(employeeService)
        })
...
export default {
  ...
  getters: {
    ...
    filteredPackagesPreselected: (state, getters) => () => {
      let preselected = getters.getPreselected
