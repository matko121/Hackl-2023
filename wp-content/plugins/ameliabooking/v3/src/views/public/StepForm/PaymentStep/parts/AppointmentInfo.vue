...
onMounted(() => {
  ...
  appointments.prepaid.concat(appointments.postpaid).forEach((appointment) => {
    ...
    let servicePrice = appointment.duration in service.customPricing.durations
      ? employeeService.customPricing.durations[appointment.duration].price : employeeService.price
