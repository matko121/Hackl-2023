  ...
  >
    <template #header>
      ...
      <div class="am-fcil__filter">
        ...
        <Transition name="slide-fade">
          <div
            v-if="shortcodeData.location.length !== 1 && amEntities.locations.length > 1 && customizedOptions.filterLocation.visibility && filterMobileMenu && !licence.isLite"
            class="am-fcil__filter-item"
...
let filterClassWidth = computed(() => {
  ...
  let locationVisibility = customizedOptions.value.filterLocation.visibility && pLocation.length !== 1 && aLocation > 1 && !licence.isLite
