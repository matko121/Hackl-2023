...
data.shortcodes = [
  {
    name: '(Selected Nothing) Entity -> Package -> Persons -> Extras -> Calendar',
    shortcodeData: {
    },
    entities: true,
    items: [
  ...
  {
    name: '(Selected Service and Employee with Many Services and One Location) Package -> Persons -> Extras -> Calendar',
    shortcodeData: {
