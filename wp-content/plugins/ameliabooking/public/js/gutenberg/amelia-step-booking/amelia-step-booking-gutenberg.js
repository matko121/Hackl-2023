    ...
    edit: function (props) {
      ...
      function getShortCode (props, attributes) {
        ...
        if (categories.length !== 0 && services.length !== 0 && employees.length !== 0) {
          if (attributes.parametars) {
            ...
            if (attributes.service && (wpAmeliaLiteVersion || (attributes.service.length && !attributes.service.includes('')))) {
              shortCode += ' service=' + attributes.service + ''
            } else if (attributes.category && (wpAmeliaLiteVersion || (attributes.category.length && !attributes.category.includes('')))) {
              shortCode += ' category=' + attributes.category + ''
            }

            if (attributes.employee && (wpAmeliaLiteVersion || (attributes.employee.length && !attributes.employee.includes('')))) {
              shortCode += ' employee=' + attributes.employee + ''
            }

            if (attributes.location && (wpAmeliaLiteVersion || (attributes.location.length && !attributes.location.includes('')))) {
              shortCode += ' location=' + attributes.location + ''
            }

            if (attributes.package && (wpAmeliaLiteVersion || (attributes.package.length && !attributes.package.includes('')))) {
      ...
      if (categories.length !== 0 && services.length !== 0 && employees.length !== 0) {
        ...
        if (attributes.parametars) {
          ...
          inspectorElements.push(el(components.SelectControl, {
            id: 'amelia-js-select-service' + (wpAmeliaLiteVersion ? '-lite' : ''),
          ...
          inspectorElements.push(el(components.SelectControl, {
            id: 'amelia-js-select-employee' + (wpAmeliaLiteVersion ? '-lite' : ''),
          ...
          inspectorElements.push(el(components.SelectControl, {
            id: 'amelia-js-select-location' + (wpAmeliaLiteVersion ? '-lite' : ''),
            className: 'amelia-gutenberg-multi-select',
          ...
          if (packages.length) {
            inspectorElements.push(el(components.SelectControl, {
              id: 'amelia-js-select-package' + (wpAmeliaLiteVersion ? '-lite' : ''),
