export default {
  ...
  methods: {
    ...
    getCurrencySymbol (isBackend = false) {
      ...
      return (typeof defaultCurrency !== 'undefined' && defaultCurrency && isBackend && defaultCurrency.code !== 'INR') ? defaultCurrency.symbol_native
        : (typeof defaultCurrency !== 'undefined' && defaultCurrency && isBackend && defaultCurrency.code === 'INR') ? defaultCurrency.code : this.$root.settings.payments.currency
    },
