  ...
  <div>
    <div class="am-dialog-scrollable">
      ...
      <el-form :model="settings" ref="settings" :rules="rules" label-position="top" @submit.prevent="onSubmit">
        ...
        <!-- Redirect URLs -->
        <el-popover :disabled="!$root.isLite" ref="redirectUrlsPop" v-bind="$root.popLiteProps"><PopLite/></el-popover>
        <el-collapse v-popover:redirectUrlsPop>
          <el-collapse-item :class="{'am-lite-disabled': ($root.isLite)}" class="am-setting-box">
            <template slot="title">
