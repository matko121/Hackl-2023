              ...
              <el-col :lg="9" :md="9" :sm="9" style="display: flex; margin: auto;">
                <div class="am-appointment-status" @click.stop>
                  ...
                  <el-select
                      ...
                      @change="updatePackageAppointmentStatus($event, appointment, packageCustomer)"
...
export default {
  ...
  methods: {
    ...
    updatePackageAppointmentStatus (newStatus, appointment, packageCustomer) {
      let originalStatus = appointment.status
      appointment.status = newStatus
      this.$emit('updatePackageAppointmentStatus', appointment, packageCustomer, originalStatus)
    },
