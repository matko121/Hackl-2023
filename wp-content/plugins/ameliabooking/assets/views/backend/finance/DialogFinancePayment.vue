...
export default {
    ...
    methods: {
      ...
      paymentRefundable (payment) {
        return (!this.$root.licence.isBasic && !this.$root.licence.isLite) && (payment.status === 'partiallyPaid' || payment.status === 'paid') && (payment.transactionId || payment.wcOrderId) && (payment.gateway !== 'mollie' || (payment.transactionId && !payment.transactionId.includes('pl_'))) && payment.gateway !== 'onSite'
      },
